...
printf ("O PIB da carta 02 é a vencedora\n");

if (pibc1>pibc2)
printf ("O PIB per capito da carta 01 é a vencedora\n");
else
printf ("O PIB per capito da carta 02 é a vencedora\n");

if (npt1>npt2)
printf ("A carta 01 é a vencedora, possui o maior numero de pontos turisticos\n");
else
printf ("A carta 02 é a vencedora, possui o maior numero de pontos turisticos\n");
